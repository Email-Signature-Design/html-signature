(function(){
  ...
  var state = {
    template: "modern",
    name:"Dr. Nikko Anderson", title:"System Engineer", company:"EVac Tech", email:"", phone:"(907) 842-2334", mobile:"", website:"", address:"546 Kenny Wren Rd. CA",
    logo: null,
    socials: {},
  ...
  function socialIconsRow(){
    ...
    var cells = active.map(function(s){
      ...
      return '<td style="padding:0 6px 0 0;">' +
        ...
        '<img src="'+icon+'" width="22" height="22" border="0" alt="'+esc(s.label)+'" style="width:22px;height:22px;border:0;border-radius:50%;display:block;">' +
        '</a></td>';
    }).join("");
    return '<tr><td style="padding-top:'+spacingPx()+'px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>'+cells+'</tr></table></td></tr>';
  }
  ...
  function contactRow(type, label, value, href, o){
    ...
    var inner = href ? '<a href="'+esc(href)+'" style="color:'+(o.linkColor || defaultLinkColor)+';text-decoration:none;border:none;outline:none;">'+v+'</a>' : v;
    var iconImg = '<img src="'+contactIconUri(type, color)+'" width="'+(o.iconSize||14)+'" height="'+(o.iconSize||14)+'" border="0" style="border:none;outline:none;vertical-align:middle;margin-right:7px;display:inline-block;">';
    return '<tr><td style="padding-top:'+(o.gap != null ? o.gap : Math.max(3, spacingPx()-2))+'px;font-family:'+state.font+';font-size:'+state.fontSize+'px;color:'+(o.textColor || state.textColor)+';border:none;">'+
      iconImg + inner + '</td></tr>';
  }
  ...
  function rawPhotoImg(size){
    ...
    return '<img src="'+state.logo+'" width="'+size+'" border="0" alt="'+esc(state.name || state.company || "Photo")+'" style="width:'+size+'px;height:'+size+'px;object-fit:cover;border:0;border-radius:'+photoRadius()+';display:block;">';
  }
  ...
  function wrapDoc(inner){
    return '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;max-width:600px;font-family:'+state.font+';">'+
  ...
  var TEMPLATE_BUILDERS = {
    ...
    modern: function(){
      ...
      var main = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border:0;border-collapse:collapse;"><tr>' +
        ...
        '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr><td style="font-size:'+(parseInt(state.fontSize,10)+6)+'px;font-weight:bold;color:'+state.primary+';padding-bottom:2px;font-family:'+state.font+';">'+esc(state.name || "Your Name")+'</td></tr>' +
    ...
    executive: function(){
      ...
      var leftCell = '<td valign="top" style="padding-right:16px;">' +
        ...
        '</td>';
      var main = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' +
        leftCell + vDiv +
        '<td valign="top" style="padding-left:16px;">' +
        '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;">' + contactRows() + socialIconsRow() + '</table>' +
        '</td></tr></table>';
      return wrapDoc(main);
    },
    ...
    minimal: function(){
      ...
      var main = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' +
        ...
        '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;margin-top:10px;">' +
    ...
    corporate: function(){
      ...
      var head = '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' +
        '<td valign="middle">' +
        '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' +
        (photoImg ? '<td style="padding-right:12px;">'+photoImg+'</td>' : '') +
        '<td valign="middle">' + nameBlock({nameColor:state.primary}) + '</td>' +
        '</tr></table></td>' +
        (social ? '<td valign="top" align="right"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' + social.replace(/^<tr>|<\/tr>$/g,"").replace(/<td/g,'<td valign="top"') + '</tr></table></td>' : '') +
        '</tr></table>';
      var main = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;background:#F7F5F1;border-radius:12px;"><tr><td style="padding:18px;">' +
        head +
        '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;margin-top:10px;">' +
    ...
    creative: function(){
      ...
      var main = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' +
        ...
        '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;margin-top:'+spacingPx()+'px;">' +
    ...
    clean: function(){
      ...
      var main = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' +
        ...
        bulletLine +
        '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;margin-top:10px;">' + socialIconsRow() + '</table>' +
    ...
    professional: function(){
      ...
      var topRow = '<tr>' +
        ...
        '</td></tr>';
      var bandInner = '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' +
        ...
        '</td></tr></table>';
      var social = socialIconsRow();
      var main = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;border:1px solid #E2DED8;border-radius:12px;"><tr><td style="padding:18px 18px 14px;">' +
        '<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;border:0;">' + topRow + '</table>' +
        '</td></tr>' +
        ...
        (social ? '<tr><td style="padding:12px 18px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;">'+social+'</table></td></tr>' : '') +
        '</table>';
      return wrapDoc(main);
    },
    ...
    elegant: function(){
      var photoImg = rawPhotoImg(76);
      var inner = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;"><tr>' +
        ...
        '</table></td></tr></table>';
      var main = '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:0;background:#1B2733;border-radius:14px;"><tr><td style="padding:22px;">'+inner+'</td></tr></table>';
      return wrapDoc(main);
    }
  };
  ...
  function doCopySignature(){
    if(!state.name.trim()){ showToast("Add your full name before copying."); document.getElementById("in-name").focus(); return; }
    var sigHtml = buildSignatureHtml();

    // Preferred: modern Clipboard API with a real text/html payload.
    // This copies the signature as rich formatted content, so pasting into
    // Gmail/Outlook/Apple Mail drops in the actual rendered signature —
    // not raw code, and with no stray borders/outlines from selection artifacts.
    if(window.ClipboardItem && navigator.clipboard && navigator.clipboard.write){
      try{
        var htmlBlob = new Blob([sigHtml], {type: "text/html"});
        var textBlob = new Blob([htmlToPlainText(sigHtml)], {type: "text/plain"});
        navigator.clipboard.write([
          new ClipboardItem({"text/html": htmlBlob, "text/plain": textBlob})
        ]).then(function(){
          showToast("Signature copied — paste it into your email client!");
        }).catch(function(){
          copySignatureViaSelection(sigHtml);
        });
        return;
      }catch(e){
        copySignatureViaSelection(sigHtml);
  ...
  function copySignatureViaSelection(sigHtml){
    // Fallback for browsers without Clipboard API "write" support.
    try{
      var doc = previewFrame.contentDocument;
      ...
      else { copyText(sigHtml, "Signature HTML copied — paste using 'Paste and match style' if needed."); }
    }catch(e){
      copyText(sigHtml, "Signature HTML copied — paste using 'Paste and match style' if needed.");
    }
  }
